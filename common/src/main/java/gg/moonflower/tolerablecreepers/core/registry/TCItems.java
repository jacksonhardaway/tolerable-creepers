...
import gg.moonflower.tolerablecreepers.common.item.FireBombItem;
import gg.moonflower.tolerablecreepers.common.item.MischiefArrowItem;
import gg.moonflower.tolerablecreepers.common.item.SporeBombItem;
...
public class TCItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(TolerableCreepers.MOD_ID, Registry.ITEM_REGISTRY);
